package constant
{
	public class NetConstant
	{
		...
		//二维码
		public static const QRCODEURL:String = "http://web.newsapp.cibntv.net/share/qrcode.php?size=4&url=aHR0cDovL3dlYi5uZXdzYXBwLmNpYm50di5uZXQvYXBwL3BsYXkvP2lkPTU3NDIzNw==";
		//推荐页
